...
namespace GoGreenV3.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register([Bind(Include = "UserName,Email,Password,ConfirmPassword,FirstName,LastName,BirthDate,CellphoneNumber,TelephoneNumber,Type,Agency,MemberSince,LastActive,AvatarUrl")] RegisterViewModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser
                {
                    ...
                    AvatarUrl = String.IsNullOrEmpty(model.AvatarUrl) ? SetDefaultAvatar(model.Type) : model.AvatarUrl
                };
        ...
        private string SetDefaultAvatar(String type)
        {
            switch (type)
            {
                case "Hospital": return "/Images/Home/Hospital.png";
                case "Police Department": return "/Images/Home/Police.png";
                default: return "/Images/Home/Fire.png";
            }
        }
